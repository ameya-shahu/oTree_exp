...
class Player(BasePlayer):
    ...
    instructionquestion4=models.IntegerField(label="आदर्श हप्तापेक्षा तुम्हाला किती वेळा कमी पैसे देण्याची परवानगी आहे?",
                                             choices=[1,2,3,4])
    ...
    instructionquestion6=models.IntegerField(label="नवीन आदर्श हप्ता फक्त पुढील फेरीसाठी लागू आहे की त्यानंतरच्या सर्व फेऱयांसाठी?",
                                             choices=[[1,"फक्त पुढील फेरीसाठी"],[2,"त्यानंतरच्या सर्व फेऱयांसाठी"]])
    instructionquestion7=models.IntegerField(label="तुम्ही 3 वेळा आदर्श गुंतवणूकीपेक्षा कमी पैसे दिल्यानंतर काय होईल?",
