...
class Player(BasePlayer):
    ...
    sleepPattern = models.IntegerField(
        ...
        choices=[
            ...
            [1, 'ए मी नेहमीपेक्षा काही जास्त झोपतो.'],
            [1, 'बी मी नेहमीपेक्षा काहीसे कमी झोपतो.'],
            [2, 'ए मी नेहमीपेक्षा जास्त झोपतो.'],
            [2, 'बी मी नेहमीपेक्षा खूपच कमी झोपतो.'],
            [3, 'ए मी दिवसभर झोपतो.'],
            [3, 'बी मी 1-2 तास लवकर उठतो आणि पुन्हा झोपू शकत नाही. '],
        ]
    )
    ...
    hunger = models.IntegerField(
        ...
        choices=[
            ...
            [1, 'ए माझी भूक नेहमीपेक्षा काहीशी कमी आहे.'],
            [1, 'बी माझी भूक नेहमीपेक्षा थोडी जास्त आहे.'],
            [2, 'अ माझी भूक पूर्वीपेक्षा खूपच कमी आहे.'],
            [2, 'बी माझी भूक नेहमीपेक्षा जास्त आहे.'],
            [3, 'ए मला भूक मुळीच नाही.'],
            [3, 'बी मी नेहमी अन्न खावेसे वाटते.'],
        ]
    )
