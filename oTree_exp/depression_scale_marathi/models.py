...
# Second Page model
    ...
    hunger = models.IntegerField(
        ...
        choices=[
            ...
            [2, 'बी माझी भूक नेहमीपेक्षा थोडी जास्त आहे.'],
            [3, 'अ माझी भूक पूर्वीपेक्षा खूपच कमी आहे.'],
            [4, 'बी माझी भूक नेहमीपेक्षा जास्त आहे.'],
            [5, 'ए मला भूक मुळीच नाही.'],
            [6, 'बी मी नेहमी अन्न खावेसे वाटते.'],
        ]
    )
