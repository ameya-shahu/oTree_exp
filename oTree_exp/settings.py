...
SESSION_CONFIGS = [
    ...
    #     app_sequence=['welcome_screen', 'depression_scale_marathi', 'instruction_display_hindi','instructions_quiz_hindi',
    #                   'control_marathi', 'saving_game_lite', 'SES_hindi'],
    # ),
    # dict(
    #     name='hybrid_hindi',
    ...
    #     num_demo_participants=1,
    #     app_sequence=['welcome_screen', 'depression_scale_marathi', 'instruction_display_hindi','instructions_quiz_hindi',
    #                   'hybrid_hindi', 'saving_game_lite', 'SES_hindi'],
    # ),
    # dict(
    ...
    #     num_demo_participants=1,
    #     app_sequence=['welcome_screen', 'depression_scale_marathi', 'instruction_display_hindi','instructions_quiz_hindi',
    #                   'expenditureanxiety_hindi', 'saving_game_lite', 'SES_hindi'],
    # ),
    # dict(
    ...
    #     num_demo_participants=1,
    #     app_sequence=['welcome_screen', 'depression_scale_marathi', 'instruction_display_hindi','instructions_quiz_hindi',
    #                   'incomeuncertainty_marathi', 'saving_game_lite', 'SES_hindi'],
    # ),
    dict(
        name='income_uncertainty_hindi',
        display_name='experiment with income uncertainty - hindi',
        num_demo_participants=1,
        app_sequence=['welcome_screen', 'depression_scale_hindi', 'instruction_display_hindi','instructions_quiz_hindi',
                      'incomeuncertainty_hindi', 'saving_game_lite_hindi', 'SES_hindi'],
    ),
    dict(
        name='expenditure_anxiety_hindi',
        display_name='experiment with expenditure anxiety - hindi',
        num_demo_participants=1,
        app_sequence=['welcome_screen', 'depression_scale_hindi', 'instruction_display_hindi','instructions_quiz_hindi',
                      'expenditureanxiety_hindi', 'saving_game_lite_hindi', 'SES_hindi'],
    ),
    dict(
        name='hybrid_hindi',
        display_name='experiment with hybrid questions - hindi',
        num_demo_participants=1,
        app_sequence=['welcome_screen', 'depression_scale_hindi', 'instruction_display_hindi','instructions_quiz_hindi',
                      'hybrid_hindi', 'saving_game_lite_hindi', 'SES_hindi'],
    ),
    dict(
        name='control_hindi',
        ...
        num_demo_participants=1,
        app_sequence=['welcome_screen', 'depression_scale_hindi', 'instruction_display_hindi','instructions_quiz_hindi',
                      'control_hindi', 'saving_game_lite_hindi', 'SES_hindi'],
    ),
    dict(
        name='debug1',
        display_name='debug1',
