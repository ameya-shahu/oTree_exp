...
class Player(BasePlayer):
    doyouwatchbollywood=models.BooleanField(label="आपण बॉलिवूड चित्रपट पाहता का?", choices=yesNoChoice)
    ...
    doyoulikesongs=models.BooleanField(label=" बॉलिवूड गाणी तुम्हाला आवडतात का?",choices=yesNoChoice)
    ...
    favsinger4=models.IntegerField(label="आपल्या आवडत्या गायकाची निवड कराः:", choices=[[1,"के.के."],[2, "सोनू निगम"]])
