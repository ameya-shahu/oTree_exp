...
PG_MY_FIELD_SUM_GREAT_ERROR = 'आपकी कुल बचत और खर्च 10,000 रुपये से अधिक हैं।'
PG_MY_FIELD_SUM_LESS_ERROR = 'आपकी कुल बचत और खर्च 10,000 रुपये से कम हैं।'

PG_MY_CONSUME_LESS_ERROR = 'आपका खर्च 3000 से कम है। यह खर्च करने के लिए न्यूनतम राशि है।'
...
PG_DEBTCHOICE_LESS_SAVINGS_ERROR = 'आपकी बचत अप्रत्याशित व्यय ({}) से कम है। आपको उधार लेना चाहिए। बचत और ऋण का योग अप्रत्याशित व्यय ({}) के बराबर होना चाहिए।'
...
PG_DEBT_LESS_HOME_SAVE_ERROR = 'घर में आपकी बचत आपके द्वारा दर्ज राशि से कम है।'
PG_DEBT_LESS_BANK_SAVE_ERROR = 'बैंक में आपकी बचत दर्ज की गई राशि से कम है।'